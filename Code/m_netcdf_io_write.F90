...
! !INTERFACE:
!
      subroutine Ncwr_1d (varwr_1d, ncid, varname, strt1d, cnt1d)
!
! !USES:
!
      use m_do_err_out
...
!
      ...
      ierr = Nf_Put_Vara_Real (ncid, varid, strt1d, cnt1d, varwr_1d_tmp)
...
! !INTERFACE:
!
      subroutine Ncwr_2d (varwr_2d, ncid, varname, strt2d, cnt2d)
!
! !USES:
!
      use m_do_err_out
...
! !LOCAL VARIABLES:
      ...
      integer             :: ierr
      integer             :: varid
      real*4              :: varwr_2d_tmp(cnt2d(1), cnt2d(2))
!
      ierr = Nf_Inq_Varid (ncid, varname, varid)
      ...
      ierr = Nf_Put_Vara_Real (ncid, varid, strt2d, cnt2d, varwr_2d_tmp)
...
! !INTERFACE:
!
      subroutine Ncwr_3d (varwr_3d, ncid, varname, strt3d, cnt3d)
!
! !USES:
!
      use m_do_err_out
...
! !LOCAL VARIABLES:
      ...
      integer             :: ierr
      integer             :: varid
      real*4              :: varwr_3d_tmp(cnt3d(1), cnt3d(2), cnt3d(3))
!
      ierr = Nf_Inq_Varid (ncid, varname, varid)
      ...
      ierr = Nf_Put_Vara_Real (ncid, varid, strt3d, cnt3d, varwr_3d_tmp)
...
! !INTERFACE:
!
      subroutine Ncwr_4d (varwr_4d, ncid, varname, strt4d, cnt4d)
!
! !USES:
!
      use m_do_err_out
...
! !LOCAL VARIABLES:
      ...
      integer             :: ierr
      integer             :: varid
      real*4              :: varwr_4d_tmp(cnt4d(1), cnt4d(2), cnt4d(3), cnt4d(4))
!
      ierr = Nf_Inq_Varid (ncid, varname, varid)
      ...
      ierr = Nf_Put_Vara_Real (ncid, varid, strt4d, cnt4d, varwr_4d_tmp)
...
! !INTERFACE:
!
      subroutine Ncwr_5d (varwr_5d, ncid, varname, strt5d, cnt5d)
!
! !USES:
!
      use m_do_err_out
...
! !LOCAL VARIABLES:
      ...
      integer             :: ierr
      integer             :: varid
      real*4              :: varwr_5d_tmp(cnt5d(1), cnt5d(2), cnt5d(3), &
                              cnt5d(4), cnt5d(5))
!
      ierr = Nf_Inq_Varid (ncid, varname, varid)
      ...
      ierr = Nf_Put_Vara_Real (ncid, varid, strt5d, cnt5d, varwr_5d_tmp)
...
! !INTERFACE:
!
      subroutine Ncwr_6d (varwr_6d, ncid, varname, strt6d, cnt6d)
!
! !USES:
!
      use m_do_err_out
...
! !LOCAL VARIABLES:
      ...
      integer             :: ierr
      integer             :: varid
      real*4              :: varwr_6d_tmp(cnt6d(1), cnt6d(2), cnt6d(3), &
                                     cnt6d(4), cnt6d(5), cnt6d(6))
!
      ierr = Nf_Inq_Varid (ncid, varname, varid)
      ...
      ierr = Nf_Put_Vara_Real (ncid, varid, strt6d, cnt6d, varwr_6d_tmp)
